...
streams:
  bed:
    ...
    - exec: v4l2-ctl -d /dev/v4l/by-id/usb-046d_C922_Pro_Stream_Webcam_BC239A9F-video-index0 -c brightness=128
    - exec: v4l2-ctl -d /dev/v4l/by-id/usb-046d_C922_Pro_Stream_Webcam_BC239A9F-video-index0 -c sharpness=200
    - exec: v4l2-ctl -d /dev/v4l/by-id/usb-046d_C922_Pro_Stream_Webcam_BC239A9F-video-index0 -c auto_exposure=1
    - exec: v4l2-ctl -d /dev/v4l/by-id/usb-046d_C922_Pro_Stream_Webcam_BC239A9F-video-index0 -c exposure_time_absolute=166
